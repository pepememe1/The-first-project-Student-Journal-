...
MVP: материалы — ссылки (`kind='link'`) и текст. Загрузка файлов-материалов (`app/uploads.py`)
— следующий шаг (диск VPS ограничен, нужны лимиты — отдельной аккуратной задачей).
"""
