...
def client_ip(request) -> str:
    """IP клиента. За обратным прокси (Caddy/nginx) реальный адрес — в первом
    значении X-Forwarded-For; иначе берём прямой адрес соединения. Это важно для
    блокировки: без учёта прокси все клиенты выглядели бы как 127.0.0.1."""
