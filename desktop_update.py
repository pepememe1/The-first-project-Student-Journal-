...
def parse_version(text: str) -> tuple:
    ...
    Строка версии в продукте живёт в человекочитаемом виде (`data/core.py::APP_VERSION`
    = «Release 3.5.6»), а сравнивать надо машинно — иначе «3.5.10» окажется старше
    «3.5.9» при обычном сравнении строк.
    """
