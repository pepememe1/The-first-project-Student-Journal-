...
_WORD_GRADE = {
    "2": {"два", "две", "двойку", "двойка", "двойки", "двоечку", "двоек", "двояк",
          "неуд", "неудовлетворительно", "неудовлетворительная", "неуды"},
    "3": {"три", "тройку", "тройка", "тройки", "троечку", "троек", "трояк",
          "удовлетворительно", "удов", "удовлетворительная", "удовлетвор"},
    "4": {"четыре", "четверку", "четверка", "четверки", "четвёрочку", "четверочку",
          "четвёрку", "четверок", "хорошо", "хор", "хорошая", "хорошист"},
    "5": {"пять", "пятерку", "пятерка", "пятерки", "пятёрочку", "пятерочку", "пятёрку",
          "пятерок", "отлично", "отл", "отличная", "превосходно", "отличник"},
}
...
_ABSENCE_O = ("уважительн", "по уважит", "освобожд", "отпросил", "с разрешения",
              ...
              "на олимпиад", "по разрешению", "уважит причин")
...
_ABSENCE_N = ("пропуск", "прогул", "отсутств", "не был", "не была", "не были",
              ...
              "нет на лекц", "не присутств", "отсутствует", "нету")
...
def stt_context(roster: List[Tuple[str, str]]) -> str:
    ...
    return ("Журнал успеваемости. Оценки: два, три, четыре, пять. "
            ...
            "Команды: поставь всей группе, первым пяти по списку, создай лекцию по теме. "
