...
[![Версия](https://img.shields.io/badge/версия-Release_3.9.9-008080)](CHANGELOG.md)
[![Тесты](https://img.shields.io/badge/тесты-947_клиент_·_1845_сервер_·_575_веб_·_28_Android-2e9e5b)](#тесты)
...
Продукт находится в стадии **Release 3.9.9** и готовится к первому коммерческому внедрению
...
Держим зелёными: **947 клиентских**, **1845 серверных**, **575 веб-тестов**, **28 Android** (22.09.2026).
...
cd server && pytest       # серверные тесты (~20–30 минут: ГОСТ-хеш на 200 000 итераций)
...
| `app/routers/messenger/` | Мессенджер и модерация — ПАКЕТ: `_common.py` + модули по темам (онлайн-only, вне синка) |
...
| `docs/security/` | Архитектура безопасности, базовый уровень ASVS, регламент инцидентов, субобработчики, сроки хранения, контур ViPNet для ВСГУТУ |
