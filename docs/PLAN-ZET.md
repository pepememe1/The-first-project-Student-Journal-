...
ЗЕТ по предмету засчитываются **только при сдаче предмета**:

| Результат экзамена/зачёта | ЗЕТ засчитаны? |
|---|---|
| Оценка 5, 4, 3 | ✅ Да |
| Зачтено | ✅ Да |
| Оценка 2 | ❌ Нет |
| Не зачтено | ❌ Нет |
| Неявка (Н) | ❌ Нет |
| Пересдача — сдал | ✅ Да (по итоговому результату) |
| Предмет без экзамена — средний балл >= 3.0 | ✅ Да |
